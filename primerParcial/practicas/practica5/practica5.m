...
% Solicitar al usuario el porcentaje de ruido a aplicar
porcentaje_ruido = input('Introduce el porcentaje de ruido a aplicar (0-100): ');

% Verificar que el porcentaje está en el rango correcto
if porcentaje_ruido < 0 || porcentaje_ruido > 100
    error('El porcentaje de ruido debe estar en el rango de 0 a 100.');
end

% Agregar ruido gaussiano a la imagen con el porcentaje proporcionado
img_ruido = imnoise(img,'gaussian', 0, (porcentaje_ruido / 100));
